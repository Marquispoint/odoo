{
    ...
    'depends': ['base', 'sale_management', 'purchase', 'stock', 'account', 'purchase_stock', 'crm',
                'ol_property_custom', 'project', 'hr', 'hr_payroll'],
    'data': [
        ...
        'views/inherited_branch_on_property.xml',
        'views/inherited_analytic_account.xml',
        'views/inherited_project.xml',
